...
test_that("it returns proper results", {
  ...
  expect_equal(models.link["test.gitsbe", "CASP9"], 0)
  expect_equal(models.link["test2.gitsbe", "CASP9"], 1)
  expect_equal(models.link["test3.gitsbe", "CASP9"], 1)
  expect_equal(models.link.extra["test.gitsbe", "MAP3K7"], 0.5)
})
