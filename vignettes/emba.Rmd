...
This is justifiable, since the number of models in the synergistic and antagonistic model groups can be fairly unbalanced and the `penalty` term aim to correct this bias.
